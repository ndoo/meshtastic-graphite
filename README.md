...
usage: meshtastic-graphite [-h] [-H MQTT_HOST] [-P MQTT_PORT] [-u MQTT_USER] [-p MQTT_PASSWORD]
                           [-t MQTT_ROOT_TOPIC] [-c MESHTASTIC_CHANNEL] [-k MESHTASTIC_KEY] -g
                           GRAPHITE_SERVER [-G GRAPHITE_PREFIX] [-d] [-v]
...
options:
  ...
  -k MESHTASTIC_KEY, --meshtastic-key MESHTASTIC_KEY
                        The Meshtastic channel (default: AQ==)
